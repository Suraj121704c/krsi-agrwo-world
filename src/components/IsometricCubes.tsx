...
const CUBES: Array<{
  ...
  { position: [-D, 0, D], icon: "leaf", phase: 1.6, speed: 2.5, stretch: 0.25 },
  { position: [D, 0, -D], icon: "coin", phase: 2.4, speed: 3.9, stretch: 0.55 },
  { position: [D, 0, D], icon: "spark", phase: 0.9, speed: 2.9, stretch: 0.3 },
];
