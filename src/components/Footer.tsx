...
const SOCIAL_ICONS = [
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        <path
          d="M12.5 2h2.5L9.5 7.5 16 14h-4.5L7.5 9.5 3 14H.5L7 8 .5 2H5L8.5 6.5 12.5 2z"
          fill="#273c1d"
        />
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
        <circle cx="8" cy="8" r="6.5" stroke="#273c1d" strokeWidth="1.3" />
        <path
          d="M1.8 5.5c2 1 4 1.5 5.7 1.5s3.5-.5 4.7-1.5M3.5 12.5c.5-2 1.8-4.5 2.5-6m2 7.5c-.5-2.5-.5-5-.5-6.5"
          stroke="#273c1d"
          strokeWidth="1.1"
          strokeLinecap="round"
        />
        ...
        >
          {NAV_LINKS.map((link) => (
            <Link
              ...
              onMouseEnter={(e) =>
                ((e.target as HTMLElement).style.color = "#65940c")
              }
              onMouseLeave={(e) =>
                ((e.target as HTMLElement).style.color = "#273c1d")
              }
            >
              {link}
            </Link>
